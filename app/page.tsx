  ...
  const pillars = [
    {
      ...
      stat: "95%",
      statLabel: `Skill Accuracy (Liu and Liu, 2024)`,
      url: "/performance",
    },
    {
      id: "health",
    ...
    },
    {
      ...
      description: `AI-powered scouting analyzing 200,000+ qualitative reports using NLP to identify undervalued players (Gordon, 2025).`,
      color: "from-blue-500 to-purple-500",
      stat: "200K+",
      statLabel: `Reports Analyzed (Gordon, 2025)`,
      url: "/strategy",
    },
    {
      id: "ethics",
        ...
        >
          ...
          <div className="prose prose-invert prose-lg max-w-4xl mx-auto mb-12">
            <p className="text-gray-400 leading-relaxed">
              AI is revolutionizing elite-level football, allowing us to
              leverage data to drive player performance to unprecedented
              heights, improve the prediction and prevention of injuries, and
              transform other kinds of activities such as recruitment. But
              achieving this requires that we treat ethics seriously—privacy
              concerns and issues of bias in algorithms must be addressed.
            </p>
          </div>
          ...
          <button
            ...
            className="group inline-flex items-center space-x-2 px-8 py-4 bg-linear-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold text-lg hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105 cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              The immense economic stakes underscore the necessity of adopting
              cutting-edge analytical tools (Jacobs, 2024).
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
              ...
              <p className="text-gray-500 text-sm">
                Current AI sports analytics market valuation (Jacobs, 2024).
              </p>
            </div>
            ...
            <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
              ...
              <p className="text-gray-500 text-sm">
                Expected market growth over the next decade (Jacobs, 2024).
              </p>
            </div>
            ...
            <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <p className="text-gray-500 text-sm">
                Exponential expansion of AI implementation, fueled by technology
                adoption (Jacobs, 2024).
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  How Getafe slashed non-contact injuries by{" "}
                  <span className="text-green-400 font-bold">66%</span> using
                  data science and predictive AI modeling (Ogden, 2021).
                </p>
              </div>
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Explore how artificial intelligence is reshaping every aspect of
              modern football
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {pillars.map((pillar, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-linear-to-br ${pillar.color} opacity-0 group-hover:opacity-10 rounded-xl transition-opacity duration-500`}
                  />

                  <div
                    className={`inline-flex p-3 rounded-lg bg-linear-to-br ${pillar.color} bg-opacity-20 mb-6`}
                  >
                    <Icon size={32} className="text-white" />
                  </div>

                  <h3
                    className="text-2xl font-bold mb-4 group-hover:bg-linear-to-r group-hover:bg-clip-text"
                    style={{
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-gray-700/50">
                    <div>
                      <div
                        className={`text-3xl font-bold bg-linear-to-r ${pillar.color} bg-clip-text text-transparent`}
                      >
                        {pillar.stat}
                      </div>
                    ...
                    <ChevronRight
                      className="text-gray-500 group-hover:text-cyan-400 group-hover:translate-x-2 transition-all duration-300"
                      size={24}
                    />
                  </div>
                </Link>
